...
const MovieCard = ({movie}) => {
  ...
  return (
    <div onDoubleClick={()=> {navigate(`/movies/${movie._id}`); scrollTo(0, 0)}} className='flex flex-col justify-between p-3 bg-gray-800 rounded-2xl hover:-translate-y-1 transition duration-300 w-66'>
